...
# Modified from  Eric Yang's 2010 version https://exchange.nagios.org/directory/Plugins/Web-Servers/nginx/check_nginx/details
# The version is 1.0.2
# Added SSL support, no cert check, misc changes
